...
<div id="wrapper" class="clearfix">
    ...
    <div class="main-content">
        ...
        <section class="inner-header divider parallax layer-overlay overlay-white-8 mt-100"
            ...
            <div class="container pt-10 pb-10">
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h3 class="text-uppercase font-weight-600 mt-0 text-theme-colored">Donate via</h3>
                ...
                <div class="row">
                    <div class="col-md-5 col-md-5 border-1px p-20">
                        <div class="row">
                            <div class="col-md-12">
                                <ul>
                                    <li class="clearfix"><span> <img src="images/lipa_na_mpesa.png" width="150"
                                                                     height="50"
                                                                     alt="Lipa na MPESA"></span>
                                    </li>
                                    <li class="clearfix"><span> PAY BILL: <b>128437</b></span></li>
                                </ul>
                                <button class="btn btn-theme-colored mt-20">Donate</button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5 col-md-offset-1 col-md-5 border-1px p-20">
                        <h3 class="text-uppercase font-weight-600 mt-0 text-theme-colored">Paypal</h3>
                        <hr>
                        <h4 class="mt-0 pt-5">One-Time Donation</h4>
                        <p>Thank you for making a donation to our charitable organization. Please use the form below to
                            pay your desired giving amount.</p>
                        <hr>

                        <!-- Paypal Form Starts -->
                        <form id="paypal_donate_form-onetime" action="https://www.paypal.com/cgi-bin/webscr"
                              method="post">
                            ...
                            <img alt="" src="www.paypal.com/en_US/i/scr/pixel.gif" width="1"
                                 height="1">
                        </form>
